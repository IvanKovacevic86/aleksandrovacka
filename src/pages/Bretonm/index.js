...
class Bretonm extends React.Component {
  render() {
   return (
  ...
  <div className="container">
    <p>Loremx ipsum dolor amet copper mug organic adaptogen forage, beard selfies squid. Godard retro vinyl banjo coloring book.</p>  
  </div> 
