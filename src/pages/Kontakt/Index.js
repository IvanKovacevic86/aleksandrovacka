...
class Kontakti extends React.Component {
  ...
  <div className="carousel-inner">
    ...
    <div className="carousel-item">
      <img src="https://source.unsplash.com/random/200x201" className="d-block w-100" alt="..."/>
    </div>
    <div className="carousel-item">
      <img src="https://source.unsplash.com/random/200x202" className="d-block w-100" alt="..."/>
    </div>
  </div>
